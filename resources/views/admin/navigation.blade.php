            ...
            <ul class="sub-menu">
                ...
                <li>
                    <a class="{{ (request()->is('admin/session_manager*')) ? 'active' : '' }}" href="{{ route('admin.settings.session_manager') }}">
                        <span>
                            {{ get_phrase('Quản lý năm học tập') }}
                        </span>
                    </a>
                </li>
                ...
                <li>
                    <a class="{{ (request()->is('admin/settings/payment*')) ? 'active' : '' }}" href="{{ route('admin.settings.payment') }}">
                        <span>
                            {{ get_phrase('Cài đặt thanh toán') }}
                        </span>
                    </a>
                </li>

                <li>
                    <a class="{{ (request()->is('admin/work_unit*')) ? 'active' : '' }}" href="{{ route('admin.workunit_list') }}">
                      <span>
                            {{ get_phrase('Thiết lập đơn vị') }}
                      </span>
                    </a>
                </li>

                <li>
                    <a class="{{ (request()->is('admin/department*')) ? 'active' : '' }}" href="{{ route('admin.department_list') }}">
                      <span>
                            {{ get_phrase('Thiết lập phòng ban') }}
