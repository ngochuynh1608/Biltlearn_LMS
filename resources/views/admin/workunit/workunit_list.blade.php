        ...
        >
          <div class="d-flex flex-column">
            ...
            <ul class="d-flex align-items-center eBreadcrumb-2">
              ...
              <li><a href="#">{{ get_phrase('Cài đặt') }}</a></li>
              <li><a href="#">{{ get_phrase('Thiết lập đơn vị') }}</a></li>
            </ul>
          </div>
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('{{ route('admin.workunit.open_modal') }}', '{{ get_phrase('Tạo đơn vị') }}')"><i class="bi bi-plus"></i>{{ get_phrase('Tạo đơn vị') }}</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-7 offset-md-2">
        <div class="eSection-wrap">
            ...
            <div class="table-responsive tScrollFix pb-2">
                             ...
                             <tr>
                                ...
                                <td>
                                    <div class="adminTable-action">
                                        ...
                                        >
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('{{ route('admin.edit.workunit', ['id' => $workunit->id]) }}', '{{ get_phrase('Chỉnh sửa') }}')">Edit</a>
                                          </li>
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="confirmModal('{{ route('admin.workunit.delete', ['id' => $workunit->id]) }}', 'undefined');">{{ get_phrase('Xóa') }}</a>
                                          </li>
                                        </ul>
                                    </div>
                                </td>
                ...
                {!! $workunits->appends(request()->all())->links() !!}
            </div>
            @else
