        ...
        >
          <div class="d-flex flex-column">
            ...
            <ul class="d-flex align-items-center eBreadcrumb-2">
              <li><a href="#"><?php echo e(get_phrase('Trang chủ')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Cài đặt')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Thiết lập đơn vị')); ?></a></li>
            </ul>
          </div>
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('admin.workunit.open_modal')); ?>', '<?php echo e(get_phrase('Tạo đơn vị')); ?>')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Tạo đơn vị')); ?></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="eSection-wrap">
            ...
            <div class="table-responsive tScrollFix pb-2">
                <table class="table eTable">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $workunits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $workunit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                <td><?php echo e($workunits->firstItem() + $key); ?></td>
                                <td><?php echo e($workunit->name); ?></td>
                                <td>
                                    <div class="adminTable-action">
                                        ...
                                        >
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('admin.edit.workunit', ['id' => $workunit->id])); ?>', '<?php echo e(get_phrase('Chỉnh sửa')); ?>')">Edit</a>
                                          </li>
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.workunit.delete', ['id' => $workunit->id])); ?>', 'undefined');"><?php echo e(get_phrase('Xóa')); ?></a>
                                          </li>
                                        </ul>
                                    </div>
                                </td>
                ...
                <?php echo $workunits->appends(request()->all())->links(); ?>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ekattor8/resources/views/admin/workunit/workunit_list.blade.php ENDPATH**/ ?>