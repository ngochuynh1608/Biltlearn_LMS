            ...
            <div class="table-responsive tScrollFix pb-2">
                  <table class="table eTable">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col"><?php echo e(get_phrase('Mã lớp')); ?></th>
                            <th scope="col"><?php echo e(get_phrase('Tên lớp')); ?></th>
                            <th scope="col"><?php echo e(get_phrase('Khóa học')); ?></th>
                            <th scope="col"><?php echo e(get_phrase('Giảng viên')); ?></th>
                            <th scope="col" class="text-end"><?php echo e(get_phrase('Hành động')); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__currentLoopData = $class_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $class_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                ...
                                <td><?php echo e($class_list->code); ?></td>
                                <td><?php echo e($class_list->name); ?></td>
                                <td>
                                    <?php $subjects = Subject::where(['id' => $class_list['subject_id']])->get(); ?>
                                ...
                                <td>
                                    <ul>
                                        <?php $teachers = User::get()->where('id', $class_list['teacher_id']); ?>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ekattor8/resources/views/admin/class/class_list.blade.php ENDPATH**/ ?>