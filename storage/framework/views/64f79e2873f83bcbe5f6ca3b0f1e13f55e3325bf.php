...
<head>
    ...
    <!-- SummerNote Css -->
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/summernote-lite.min.css')); ?>"/>
...
<body>
            ...
            <div class="iocn-link">
                <a class="<?php echo e((request()->is('admin/offline_admission*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.offline_admission.single', ['type' => 'single'])); ?>">
                    ...
                    <span class="link_name">
                        <?php echo e(get_phrase('Thêm học viên')); ?>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/exam_category*') || request()->is('admin/offline_exam*') || request()->is('admin/marks') || request()->is('admin/grade') || request()->is('admin/promotion*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a href="#">
                    ...
                    <span class="link_name">
                        <?php echo e(get_phrase('Quản lý kết quả')); ?>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/attendance*') || request()->is('admin/class_list*') || request()->is('admin/routine*') || request()->is('admin/subject*') || request()->is('admin/syllabus*') || request()->is('admin/gradebook*') || request()->is('admin/class_room*') || request()->is('admin/department*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a href="#">
                    ...
                    <span class="link_name">
                        <?php echo e(get_phrase('Quản lý đào tạo')); ?>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/fee_manager*') || request()->is('admin/offline_payment/pending*')|| request()->is('admin/expense_category*') || request()->is('admin/expenses*') ? 'showMenu':''); ?>">
            ...
            <ul class="sub-menu">
                ...
                <li><a class="<?php echo e((request()->is('admin/offline_payment/pending*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.offline_payment_pending')); ?>"><span>
                            <?php echo e(get_phrase('Yêu cầu thanh toán')); ?>
        ...
        <li class="nav-links-li <?php echo e(request()->is('admin/book*') || request()->is('admin/book_issue*') || request()->is('admin/noticeboard*') || request()->is('admin/subscription') || request()->is('admin/events/list*') ? 'showMenu':''); ?>">
            <div class="iocn-link">
                <a href="#">
                    ...
                    <span class="link_name">
                        <?php echo e(get_phrase('Tiện ích')); ?>
            ...
            <ul class="sub-menu">
                ...
                <li><a class="<?php echo e((request()->is('admin/noticeboard*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.noticeboard.list')); ?>"><span>
                            <?php echo e(get_phrase('Bảng thông báo')); ?>
            ...
            <ul class="sub-menu">
                <li>
                    <a class="<?php echo e((request()->is('admin/settings/school*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.school')); ?>">
                        <span>
                            <?php echo e(get_phrase('Cài đặt hệ thống')); ?>
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/session_manager*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.session_manager')); ?>">
                        <span>
                            <?php echo e(get_phrase('Quản lý năm học tập')); ?>
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/settings/payment*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.payment')); ?>">
                        <span>
                            <?php echo e(get_phrase('Cài đặt thanh toán')); ?>
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/work_unit*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.workunit_list')); ?>">
                      <span>
                            <?php echo e(get_phrase('Thiết lập đơn vị')); ?>
                ...
                <li>
                    <a class="<?php echo e((request()->is('admin/department*')) ? 'active' : ''); ?>" href="<?php echo e(route('admin.department_list')); ?>">
                      <span>
                            <?php echo e(get_phrase('Thiết lập phòng ban')); ?>
                      ...
                      >
                        ...
                        <li>
                          <a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>">
                            ...
                            <?php echo e(get_phrase('Tài khoản của tôi')); ?>
                        ...
                        <li>
                          <a class="dropdown-item" href="<?php echo e(route('admin.password', ['edit'])); ?>">
                            ...
                            <?php echo e(get_phrase('Thay đổi mật khẩu')); ?>
    ...
    <!-- Dragula js -->
    <script src="<?php echo e(asset('public/assets/js/dragula.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/assets/js/onDomChange.js')); ?>"></script>
    <script src="<?php echo e(asset('public/assets/js/Sortable.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/assets/js/jquery-sortable.js')); ?>"></script>
    <!-- SummerNote Js -->
    <script src="<?php echo e(asset('public/assets/js/summernote-lite.min.js')); ?>"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ekattor8/resources/views/admin/navigation.blade.php ENDPATH**/ ?>